...
<body>
  <div class="sidebar">
    ...
    <i class='bx bx-train'></i>
      <span class="logo_name">My Travel Partner</span>
    </div>
      <ul class="nav-links" style="padding-left:0px">
        ...
        <!-- <li>
          <a href="#">
            ...
            <span class="links_name">Train</span>
  ...
  <section class="home-section">
       ...
       <div class="overview-boxes">
        <div class="box bg-danger">
          <div class="right-side">
            <div class="box-topic">Booking train</div>
        ...
        <div class="box bg-success">
          <div class="right-side">
            <div class="box-topic"> Approved Ticket</div>
    ...
    <button class="btn btn-primary my-4"><a href="addtrain.php" class="text-light" style="text-decoration:none">Add train</a></button>
<table class="table " id="myTable">

       <!-- <div class="search my-4" >

      <input id="myInput" type="text"  placeholder="search train" style="border-radius:5px; height : 40px; text-align:center;">
</div> -->
         ...
         while($row = mysqli_fetch_assoc($result)){
           //  $sno = $sno+1;
            ...
            echo '<tr>
              ...
              <td> 
              <button class="btn btn-primary"><a href="update.php?updateid='.$sno.'"
               class="text-light" style="text-decoration:none">Edit</a></button> 
               <button class="btn btn-danger"><a href="delete-train.php?deleteid='.$sno.'"
